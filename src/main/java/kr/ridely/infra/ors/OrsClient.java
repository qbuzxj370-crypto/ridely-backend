 ...
 *   - 호스트는 api.heigit.org다. 구 도메인 api.openrouteservice.org는 2026-08-24에 셧오프됐다. 그 뒤 호출은 403에 {"error": "Access to this API has been disallowed"}가 오는데, 게이트웨이가 내는 문구라 키 문제로 오인하기 쉽다. 키를 새로 발급해도 풀리지 않는다
