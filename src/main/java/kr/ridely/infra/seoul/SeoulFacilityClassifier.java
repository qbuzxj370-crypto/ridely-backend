 ...
 * 이름으로 뒤집으면 우리 추측을 원본 입력 위에 두게 되므로 하지 않는다.
...
public class SeoulFacilityClassifier {
     ...
     *
     * 07이 채워진 건은 수리 문구가 명확해 확실하고, 06만 걸린 건은 상대적으로 덜 확실하다.
